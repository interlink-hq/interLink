...
function HomepageHeader() {
  ...
  return (
    <header className={clsx('hero hero--primary', styles.heroBanner)}>
      ...
      <img alt="Slack" src="https://img.shields.io/github/stars/intertwin-eu/interlink" style={{ marginTop: '1rem' }} onClick={() => window.location.href='https://github.com/interTwin-eu/interLink'}/>
      <br/>
      ...
      <br/>
      <img alt="Slack" src="https://goreportcard.com/badge/github.com/intertwin-eu/interlink" style={{ marginTop: '1rem' }} onClick={() => window.location.href='https://goreportcard.com/report/github.com/intertwin-eu/interlink'}/>
      <HomepageFeatures />
      </div>
    </header>
  );
